...
Install [v0.4.3](https://github.com/hilmimuktitama/herdr-jira-peek/releases/tag/v0.4.3),
pinned to its release commit:

```sh
herdr plugin install hilmimuktitama/herdr-jira-peek --ref 53239981368a52f3c01f27e56161201c8c194abc
```
